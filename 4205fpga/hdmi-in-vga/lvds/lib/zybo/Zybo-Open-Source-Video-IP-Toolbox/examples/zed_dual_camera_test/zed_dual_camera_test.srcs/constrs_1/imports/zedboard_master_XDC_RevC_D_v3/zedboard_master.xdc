...
# Clock dedicated routes for cameras
...
set_property PACKAGE_PIN AA11 [get_ports {sioc_0}];  # "JA2"
set_property IOSTANDARD LVCMOS33 [get_ports {sioc_0}];
set_property PACKAGE_PIN Y10  [get_ports {vsync_0}];  # "JA3"
set_property IOSTANDARD LVCMOS33 [get_ports {vsync_0}];
set_property PACKAGE_PIN AA9  [get_ports {pclk_0}];  # "JA4"
set_property IOSTANDARD LVCMOS33 [get_ports {pclk_0}];
#set_property PACKAGE_PIN AB11 [get_ports {data[1]}];  # "JA7"
#set_property IOSTANDARD LVCMOS33 [get_ports {data[1]}];
set_property PACKAGE_PIN AB10 [get_ports {siod_0}];  # "JA8"
set_property IOSTANDARD LVCMOS33 [get_ports {siod_0}];
set_property PACKAGE_PIN AB9  [get_ports {hsync_0}];  # "JA9"
set_property IOSTANDARD LVCMOS33 [get_ports {hsync_0}];
set_property PACKAGE_PIN AA8  [get_ports {xclk_0}];  # "JA10"
set_property IOSTANDARD LVCMOS33 [get_ports {xclk_0}];

# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {data_0[7]}];  # "JB1"
#set_property IOSTANDARD LVCMOS33 [get_ports {data_0[7]}];
set_property PACKAGE_PIN W11 [get_ports {sioc_1}];  # "JB2"
set_property IOSTANDARD LVCMOS33 [get_ports {sioc_1}];
set_property PACKAGE_PIN V10 [get_ports {vsync_1}];  # "JB3"
set_property IOSTANDARD LVCMOS33 [get_ports {vsync_1}];
set_property PACKAGE_PIN W8 [get_ports {pclk_1}];  # "JB4"
set_property IOSTANDARD LVCMOS33 [get_ports {pclk_1}];
#set_property PACKAGE_PIN V12 [get_ports {data_0[6]}];  # "JB7"
#set_property IOSTANDARD LVCMOS33 [get_ports {data_0[6]}];
set_property PACKAGE_PIN W10 [get_ports {siod_1}];  # "JB8"
set_property IOSTANDARD LVCMOS33 [get_ports {siod_1}];
set_property PACKAGE_PIN V9 [get_ports {hsync_1}];  # "JB9"
set_property IOSTANDARD LVCMOS33 [get_ports {hsync_1}];
set_property PACKAGE_PIN V8 [get_ports {xclk_1}];  # "JB10"
set_property IOSTANDARD LVCMOS33 [get_ports {xclk_1}];

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB7 [get_ports {data_0[7]}];  # "JC1_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[7]}];
set_property PACKAGE_PIN AB6 [get_ports {data_0[5]}];  # "JC1_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[5]}];
set_property PACKAGE_PIN Y4  [get_ports {data_0[3]}];  # "JC2_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[3]}];
set_property PACKAGE_PIN AA4 [get_ports {data_0[1]}];  # "JC2_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[1]}];
set_property PACKAGE_PIN R6  [get_ports {data_0[6]}];  # "JC3_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[6]}];
set_property PACKAGE_PIN T6  [get_ports {data_0[4]}];  # "JC3_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[4]}];
set_property PACKAGE_PIN T4  [get_ports {data_0[2]}];  # "JC4_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[2]}];
set_property PACKAGE_PIN U4  [get_ports {data_0[0]}];  # "JC4_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_0[0]}];

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN V7 [get_ports {data_1[7]}];  # "JD1_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[7]}];
set_property PACKAGE_PIN W7 [get_ports {data_1[5]}];  # "JD1_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[5]}];
set_property PACKAGE_PIN V5 [get_ports {data_1[3]}];  # "JD2_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[3]}];
set_property PACKAGE_PIN V4 [get_ports {data_1[1]}];  # "JD2_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[1]}];
set_property PACKAGE_PIN W6 [get_ports {data_1[6]}];  # "JD3_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[6]}];
set_property PACKAGE_PIN W5 [get_ports {data_1[4]}];  # "JD3_N"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[4]}];
set_property PACKAGE_PIN U6 [get_ports {data_1[2]}];  # "JD4_P"
set_property IOSTANDARD LVCMOS33 [get_ports {data_1[2]}];
set_property PACKAGE_PIN U5 [get_ports {data_1[0]}];  # "JD4_N"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {ready_0}];  # "LD0"
set_property IOSTANDARD LVCMOS33 [get_ports {ready_0}];
set_property PACKAGE_PIN T21 [get_ports {ready_1}];  # "LD1"
set_property IOSTANDARD LVCMOS33 [get_ports {ready_1}];
...
#set_property PACKAGE_PIN AA19 [get_ports {xclk_0}];     # "VGA-HS"
#set_property IOSTANDARD LVCMOS33 [get_ports {xclk_0}];
...
#set_property PACKAGE_PIN Y19  [get_ports {xclk_1}];     # "VGA-VS"
#set_property IOSTANDARD LVCMOS33 [get_ports {xclk_1}];
