...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {data_1[0]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {data_1[2]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {data_1[4]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {data_1[6]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {data_1[1]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {data_1[3]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {data_1[5]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {data_1[7]}];  # "JA10"
...
set_property PACKAGE_PIN W11 [get_ports {xclk_1}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {href_1}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {siod_1}];  # "JB4"
#set_property PACKAGE_PIN V12 [get_ports {JB7}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {pclk_1}];  # "JB8"
#set_property PACKAGE_PIN V9 [get_ports {vsync_1}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports {sioc_1}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB7 [get_ports {data_0[0]}];  # "JC1_P"
set_property PACKAGE_PIN AB6 [get_ports {data_0[2]}];  # "JC1_N"
set_property PACKAGE_PIN Y4  [get_ports {data_0[4]}];  # "JC2_P"
set_property PACKAGE_PIN AA4 [get_ports {data_0[6]}];  # "JC2_N"
set_property PACKAGE_PIN R6  [get_ports {data_0[1]}];  # "JC3_P"
set_property PACKAGE_PIN T6  [get_ports {data_0[3]}];  # "JC3_N"
set_property PACKAGE_PIN T4  [get_ports {data_0[5]}];  # "JC4_P"
set_property PACKAGE_PIN U4  [get_ports {data_0[7]}];  # "JC4_N"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN V7 [get_ports {JD1_P}];  # "JD1_P"
set_property PACKAGE_PIN W7 [get_ports {xclk_0}];  # "JD1_N"
set_property PACKAGE_PIN V5 [get_ports {href_0}];  # "JD2_P"
set_property PACKAGE_PIN V4 [get_ports {siod_0}];  # "JD2_N"
#set_property PACKAGE_PIN W6 [get_ports {JD3_P}];  # "JD3_P"
set_property PACKAGE_PIN W5 [get_ports {pclk_0}];  # "JD3_N"
set_property PACKAGE_PIN U6 [get_ports {vsync_0}];  # "JD4_P"
set_property PACKAGE_PIN U5 [get_ports {sioc_0}];  # "JD4_N"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {config_finished_0}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {config_finished_1}];  # "LD1"
...
set_property PACKAGE_PIN N15 [get_ports {resend_0}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {resend_1}];  # "BTNR"
