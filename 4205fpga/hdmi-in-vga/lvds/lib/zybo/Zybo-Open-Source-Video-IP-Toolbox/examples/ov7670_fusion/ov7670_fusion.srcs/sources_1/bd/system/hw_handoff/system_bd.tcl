...
proc create_root_design { parentCell } {
  ...
  set config_finished_1 [ create_bd_port -dir O config_finished_1 ]
  ...
  set href_1 [ create_bd_port -dir I href_1 ]
  ...
  set scl_1 [ create_bd_port -dir O scl_1 ]
...
CONFIG.MMCM_COMPENSATION.VALUE_SRC {DEFAULT} \
  ...
  set inverter_1 [ create_bd_cell -type ip -vlnv user.org:user:inverter:1.0 inverter_1 ]

  # Create instance: inverter_2, and set properties
  set inverter_2 [ create_bd_cell -type ip -vlnv user.org:user:inverter:1.0 inverter_2 ]
...
CONFIG.LOGO_FILE {data/sym_orgate.png} \
  ...
  # Create instance: vga_laplacian_fusion_0, and set properties
  set vga_laplacian_fusion_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:vga_laplacian_fusion:1.0 vga_laplacian_fusion_0 ]
  ...
  connect_bd_net -net Net [get_bd_ports sda_0] [get_bd_pins ov7670_controller_0/siod]
  connect_bd_net -net Net1 [get_bd_ports sda_1] [get_bd_pins ov7670_controller_1/siod]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ov7670_controller_0/clk] [get_bd_pins ov7670_controller_1/clk] [get_bd_pins vga_gaussian_blur_0/clk_25] [get_bd_pins vga_gaussian_blur_1/clk_25] [get_bd_pins vga_laplacian_fusion_0/clk_25] [get_bd_pins zybo_hdmi_0/clk_25]
  ...
  connect_bd_net -net href_0_1 [get_bd_ports href_0] [get_bd_pins inverter_0/x]
  connect_bd_net -net href_1_1 [get_bd_ports href_1] [get_bd_pins inverter_1/x]
  connect_bd_net -net inverter_0_x_not [get_bd_pins inverter_0/x_not] [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins vga_gaussian_blur_0/hsync_in] [get_bd_pins zybo_hdmi_0/hsync]
  connect_bd_net -net inverter_1_x_not [get_bd_pins inverter_1/x_not] [get_bd_pins vga_gaussian_blur_1/hsync_in]
  connect_bd_net -net inverter_2_x_not [get_bd_pins inverter_2/x_not] [get_bd_pins zybo_hdmi_0/active]
  ...
  connect_bd_net -net ov7670_controller_0_sioc [get_bd_ports scl_0] [get_bd_pins ov7670_controller_0/sioc]
  connect_bd_net -net ov7670_controller_0_xclk [get_bd_ports xclk_0] [get_bd_pins ov7670_controller_0/xclk]
  connect_bd_net -net ov7670_controller_1_config_finished [get_bd_ports config_finished_1] [get_bd_pins ov7670_controller_1/config_finished]
  connect_bd_net -net ov7670_controller_1_sioc [get_bd_ports scl_1] [get_bd_pins ov7670_controller_1/sioc]
  connect_bd_net -net ov7670_controller_1_xclk [get_bd_ports xclk_1] [get_bd_pins ov7670_controller_1/xclk]
  ...
  connect_bd_net -net pclk_1 [get_bd_ports pclk_0] [get_bd_pins ov7670_vga_0/pclk]
  connect_bd_net -net pclk_1_1 [get_bd_ports pclk_1] [get_bd_pins ov7670_vga_1/pclk]
  ...
  connect_bd_net -net resend_1 [get_bd_ports resend] [get_bd_pins ov7670_controller_0/resend] [get_bd_pins ov7670_controller_1/resend]
  connect_bd_net -net rgb565_to_rgb888_0_rgb_888 [get_bd_pins rgb565_to_rgb888_0/rgb_888] [get_bd_pins vga_gaussian_blur_0/rgb_in]
  connect_bd_net -net rgb565_to_rgb888_1_rgb_888 [get_bd_pins rgb565_to_rgb888_1/rgb_888] [get_bd_pins vga_gaussian_blur_1/rgb_in]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins inverter_2/x] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net vga_gaussian_blur_0_rgb_blur [get_bd_pins vga_gaussian_blur_0/rgb_blur] [get_bd_pins vga_laplacian_fusion_0/rgb_blur_0]
  connect_bd_net -net vga_gaussian_blur_0_rgb_pass [get_bd_pins vga_gaussian_blur_0/rgb_pass] [get_bd_pins vga_laplacian_fusion_0/rgb_pass_0]
  connect_bd_net -net vga_gaussian_blur_1_rgb_blur [get_bd_pins vga_gaussian_blur_1/rgb_blur] [get_bd_pins vga_laplacian_fusion_0/rgb_blur_1]
  connect_bd_net -net vga_gaussian_blur_1_rgb_pass [get_bd_pins vga_gaussian_blur_1/rgb_pass] [get_bd_pins vga_laplacian_fusion_0/rgb_pass_1]
  connect_bd_net -net vga_laplacian_fusion_0_rgb_out [get_bd_pins vga_laplacian_fusion_0/rgb_out] [get_bd_pins zybo_hdmi_0/rgb]
  connect_bd_net -net vsync_0_1 [get_bd_ports vsync_0] [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins vga_gaussian_blur_0/vsync_in] [get_bd_pins zybo_hdmi_0/vsync]
  connect_bd_net -net vsync_1_1 [get_bd_ports vsync_1] [get_bd_pins vga_gaussian_blur_1/vsync_in]
...
preplace port resend -pg 1 -y 500 -defaultsOSRD
preplace port hdmi_hpd -pg 1 -y 520 -defaultsOSRD
preplace port href_0 -pg 1 -y 330 -defaultsOSRD
preplace port hdmi_out_en -pg 1 -y 420 -defaultsOSRD
preplace port href_1 -pg 1 -y 740 -defaultsOSRD
preplace port scl_0 -pg 1 -y 750 -defaultsOSRD
preplace port scl_1 -pg 1 -y 570 -defaultsOSRD
preplace port sda_0 -pg 1 -y 770 -defaultsOSRD
preplace port config_finished_0 -pg 1 -y 730 -defaultsOSRD
preplace port pclk_0 -pg 1 -y 570 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port sda_1 -pg 1 -y 590 -defaultsOSRD
preplace port config_finished_1 -pg 1 -y 550 -defaultsOSRD
preplace port xclk_0 -pg 1 -y 830 -defaultsOSRD
preplace port pclk_1 -pg 1 -y 670 -defaultsOSRD
preplace port hdmi_cec -pg 1 -y 860 -defaultsOSRD
preplace port xclk_1 -pg 1 -y 650 -defaultsOSRD
preplace port vsync_0 -pg 1 -y 270 -defaultsOSRD
preplace port vsync_1 -pg 1 -y 760 -defaultsOSRD
preplace portBus tmdsb -pg 1 -y 400 -defaultsOSRD
preplace portBus data_0 -pg 1 -y 590 -defaultsOSRD
preplace portBus data_1 -pg 1 -y 690 -defaultsOSRD
preplace portBus tmds -pg 1 -y 380 -defaultsOSRD
preplace inst vga_gaussian_blur_0 -pg 1 -lvl 3 -y 610 -defaultsOSRD
preplace inst vga_gaussian_blur_1 -pg 1 -lvl 3 -y 750 -defaultsOSRD
preplace inst ov7670_controller_0 -pg 1 -lvl 5 -y 780 -defaultsOSRD
preplace inst inverter_0 -pg 1 -lvl 2 -y 330 -defaultsOSRD
preplace inst ov7670_controller_1 -pg 1 -lvl 5 -y 600 -defaultsOSRD
preplace inst util_vector_logic_1 -pg 1 -lvl 3 -y 460 -defaultsOSRD
preplace inst inverter_1 -pg 1 -lvl 2 -y 710 -defaultsOSRD
preplace inst inverter_2 -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst vga_laplacian_fusion_0 -pg 1 -lvl 4 -y 640 -defaultsOSRD
preplace inst ov7670_vga_0 -pg 1 -lvl 1 -y 580 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -y 420 -defaultsOSRD
preplace inst rgb565_to_rgb888_0 -pg 1 -lvl 2 -y 580 -defaultsOSRD
preplace inst ov7670_vga_1 -pg 1 -lvl 1 -y 680 -defaultsOSRD
preplace inst rgb565_to_rgb888_1 -pg 1 -lvl 2 -y 810 -defaultsOSRD
preplace inst zybo_hdmi_0 -pg 1 -lvl 5 -y 400 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 130 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc vga_gaussian_blur_1_rgb_blur 1 3 1 710
preplace netloc hdmi_hpd_1 1 0 5 NJ 520 NJ 520 NJ 520 NJ 520 1000J
preplace netloc data_1_1 1 0 1 NJ
preplace netloc hdmi_cec_1 1 0 5 NJ 860 NJ 860 NJ 860 NJ 860 1010J
preplace netloc href_0_1 1 0 2 NJ 330 NJ
preplace netloc zybo_hdmi_0_tmds 1 5 1 NJ
preplace netloc pclk_1_1 1 0 1 NJ
preplace netloc vga_gaussian_blur_0_rgb_blur 1 3 1 N
preplace netloc rgb565_to_rgb888_1_rgb_888 1 2 1 470J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 5 210 280 NJ 280 NJ 280 NJ 280 1390
preplace netloc ov7670_vga_1_rgb 1 1 1 200
preplace netloc vga_gaussian_blur_1_rgb_pass 1 3 1 720
preplace netloc inverter_2_x_not 1 4 1 970
preplace netloc inverter_0_x_not 1 2 3 480 330 NJ 330 960J
preplace netloc ov7670_controller_1_config_finished 1 5 1 NJ
preplace netloc ov7670_controller_0_config_finished 1 5 1 NJ
preplace netloc resend_1 1 0 5 NJ 500 NJ 500 470J 530 NJ 530 960
preplace netloc ov7670_vga_0_rgb 1 1 1 NJ
preplace netloc vga_laplacian_fusion_0_rgb_out 1 4 1 990
preplace netloc ov7670_controller_1_sioc 1 5 1 NJ
preplace netloc ov7670_controller_0_xclk 1 5 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc data_1 1 0 1 NJ
preplace netloc clk_wiz_0_clk_out1 1 2 3 460 350 710 350 980
preplace netloc ov7670_controller_1_xclk 1 5 1 NJ
preplace netloc pclk_1 1 0 1 NJ
preplace netloc vga_gaussian_blur_0_rgb_pass 1 3 1 N
preplace netloc util_vector_logic_1_Res 1 3 1 NJ
preplace netloc Net1 1 5 1 NJ
preplace netloc Net 1 5 1 NJ
preplace netloc zybo_hdmi_0_hdmi_out_en 1 5 1 NJ
preplace netloc zybo_hdmi_0_tmdsb 1 5 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 1 5 200 130 NJ 130 NJ 130 980 270 1400
preplace netloc rgb565_to_rgb888_0_rgb_888 1 2 1 450
preplace netloc vsync_1_1 1 0 3 NJ 760 NJ 760 NJ
preplace netloc ov7670_controller_0_sioc 1 5 1 NJ
preplace netloc vsync_0_1 1 0 5 NJ 270 NJ 270 490 270 NJ 270 970J
preplace netloc inverter_1_x_not 1 2 1 450J
preplace netloc href_1_1 1 0 2 NJ 740 210J
levelinfo -pg 1 0 110 330 600 840 1200 1420 -top 0 -bot 880
",
}
