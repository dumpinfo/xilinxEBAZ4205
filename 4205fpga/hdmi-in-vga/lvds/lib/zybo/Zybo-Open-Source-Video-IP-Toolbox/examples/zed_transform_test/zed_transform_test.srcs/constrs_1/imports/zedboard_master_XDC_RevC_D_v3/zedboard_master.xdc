...
# JC Pmod - Bank 13
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN AB7 [get_ports {data[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[7]}]
set_property PACKAGE_PIN AB6 [get_ports {data[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[5]}]
set_property PACKAGE_PIN Y4 [get_ports {data[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[3]}]
set_property PACKAGE_PIN AA4 [get_ports {data[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[1]}]
set_property PACKAGE_PIN R6 [get_ports {data[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[6]}]
set_property PACKAGE_PIN T6 [get_ports {data[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[4]}]
set_property PACKAGE_PIN T4 [get_ports {data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[2]}]
set_property PACKAGE_PIN U4 [get_ports {data[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data[0]}]
...
set_property PACKAGE_PIN T21 [get_ports transform_led]
set_property IOSTANDARD LVCMOS33 [get_ports transform_led]
...
set_property PACKAGE_PIN U19 [get_ports {state[0]}];  # "LD6"
set_property IOSTANDARD LVCMOS33 [get_ports {state[0]}]
set_property PACKAGE_PIN U14 [get_ports {state[1]}];  # "LD7"
...
set_property PACKAGE_PIN T18 [get_ports apply]
set_property IOSTANDARD LVCMOS33 [get_ports apply]
...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN F22 [get_ports transform]
set_property IOSTANDARD LVCMOS33 [get_ports transform]
...
add_cells_to_pblock [get_pblocks pblock_1] [get_cells -quiet [list system_i/vga_hessian_0]]
resize_pblock [get_pblocks pblock_1] -add {SLICE_X0Y25:SLICE_X49Y49}
resize_pblock [get_pblocks pblock_1] -add {DSP48_X0Y10:DSP48_X2Y19}
resize_pblock [get_pblocks pblock_1] -add {RAMB18_X0Y10:RAMB18_X2Y19}
resize_pblock [get_pblocks pblock_1] -add {RAMB36_X0Y5:RAMB36_X2Y9}
create_pblock pblock_2
add_cells_to_pblock [get_pblocks pblock_2] [get_cells -quiet [list system_i/vga_hessian_1]]
resize_pblock [get_pblocks pblock_2] -add {SLICE_X0Y0:SLICE_X49Y24}
resize_pblock [get_pblocks pblock_2] -add {DSP48_X0Y0:DSP48_X2Y9}
resize_pblock [get_pblocks pblock_2] -add {RAMB18_X0Y0:RAMB18_X2Y9}
resize_pblock [get_pblocks pblock_2] -add {RAMB36_X0Y0:RAMB36_X2Y4}
