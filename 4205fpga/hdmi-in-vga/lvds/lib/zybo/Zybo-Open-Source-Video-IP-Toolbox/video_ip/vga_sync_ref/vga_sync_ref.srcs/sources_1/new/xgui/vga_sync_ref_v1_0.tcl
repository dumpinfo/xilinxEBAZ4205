...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DELAY"
...
proc update_PARAM_VALUE.H_SYNC_SIZE { PARAM_VALUE.H_SYNC_SIZE } {
	# Procedure called to update H_SYNC_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.H_SYNC_SIZE { PARAM_VALUE.H_SYNC_SIZE } {
	# Procedure called to validate H_SYNC_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.H_SYNC_SIZE { MODELPARAM_VALUE.H_SYNC_SIZE PARAM_VALUE.H_SYNC_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.H_SYNC_SIZE}] ${MODELPARAM_VALUE.H_SYNC_SIZE}
}
