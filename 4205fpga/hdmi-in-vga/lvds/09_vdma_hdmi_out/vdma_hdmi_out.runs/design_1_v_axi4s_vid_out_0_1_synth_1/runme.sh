...
HD_PWD='/root/rg/2018.3/course_s1/09_vdma_hdmi_out/vdma_hdmi_out.runs/design_1_v_axi4s_vid_out_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_axi4s_vid_out_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_axi4s_vid_out_0_1.tcl
