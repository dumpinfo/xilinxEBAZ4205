...
HD_PWD='/root/rg/2018.3/course_s1/09_vdma_hdmi_out/vdma_hdmi_out.runs/design_1_rst_ps7_0_142M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_ps7_0_142M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_ps7_0_142M_0.tcl
